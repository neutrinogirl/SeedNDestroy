...
double GetDistanceStdVector(const std::vector<double>& v1,
...
std::vector< std::vector<double> > GetSimplexFromSeed(const std::vector<double>& vSeed,
...
void ScaleStdVector(std::vector<double>& v,
...
void ShiftVector(std::vector<double>& v,
...
std::vector< std::vector<double> > GetRegularSimplex4D(const std::vector<double>& vSeed,
						       const double& ScaleFactor=1.){
...
std::vector< std::vector<double> > GetRegularSimplex3D(const std::vector<double>& vSeed,
						       const double& ScaleFactor=1.){
...
void SmearVector(std::vector<double>& v, const std::vector<double>& s){
